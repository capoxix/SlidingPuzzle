...
class solutions {
	    ...
	    boolean findSolution(solutions steps){
	    ...
	    private void completed(String previousStep, String newStep) {
	    	...
	    	//String strings = newStep;
	        if(newStep.equals("012345678")) {
	            ...
	            while (newStep != null) {
	            	if(stepNumber.get(newStep)!=0){
	            		...
	            		System.out.println(newStep.substring(0,3));
	            		System.out.println(newStep.substring(3,6));
	            		System.out.println(newStep.substring(6,9)+"\n");
	  ...
	  //update string positions
	    void up(String currentState){
	        ...
	        if(blankPos>2){
	            String nextState = currentState.substring(0,blankPos-3)+"0"
	        +currentState.substring(blankPos-2,blankPos)
	        +currentState.charAt(blankPos-3)
	    ...
	    void down(String currentState){
	        ...
	        if(blankPos<6){
	            String nextState = currentState.substring(0,blankPos)
	            		+currentState.substring(blankPos+3,blankPos+4)
	            		+currentState.substring(blankPos+1,blankPos+3)+"0"
	            		+currentState.substring(blankPos+4);
